...
<title><?php echo $detail['nom_magazin'];?></title>
    ...
    <?php /*?><?php if(!isset($_SESSION['kt_adresse']) or empty($_SESSION['kt_adresse'])) { ?>
             ...
             <style>
				...
				<div id="tabs-1" style="position:relative">
					...
					<div class="tab_body">
                    	<div class="tab_img">
                        	<span id="img_show">
                        		<a href="assets/images/produits/<?php echo $row_liste_produits['photo1'];?>" class="MagicZoom" id="Zoomer" > <img class="maga" src="timthumb.php?src=assets/images/produits/<?php echo $row_liste_produits['photo1'];  ?>&amp;cz=1&amp;w=220&amp;h=220" alt="" /></a>
                            </span>
                            <div class="tab_list_img" >
                            	<?php if($row_liste_produits['photo1']){?>
                            	<a href="assets/images/produits/<?php echo $row_liste_produits['photo1'];?>" rel="zoom-id:Zoomer;" rev="timthumb.php?src=assets/images/produits/<?php echo $row_liste_produits['photo1'];?>&amp;cz=1&amp;w=220&amp;h=220" >
                                ...
                                <a href="assets/images/produits/<?php echo $row_liste_produits['photo2'];?>" rel="zoom-id:Zoomer;" rev="timthumb.php?src=assets/images/produits/<?php echo $row_liste_produits['photo2'];?>&amp;cz=1&amp;w=220&amp;h=220" >
                                ...
                                <a href="assets/images/produits/<?php echo $row_liste_produits['photo3'];?>" rel="zoom-id:Zoomer;" rev="timthumb.php?src=assets/images/produits/<?php echo $row_liste_produits['photo3'];?>&amp;cz=1&amp;w=220&amp;h=220" >
                        ...
                        <div class="tab_contact">
                        	<div class="contact_info" style="float:right !important;">
                                ...
                                <div style="float:right;">
                                	<a style="padding:5px 10px; float:right; background:#F6AE30; color:#FFF;" onClick="ajax('ajax/addtoCoursesList.php?id_produit=<?php echo $row_liste_produits['id'];  ?>','#carts');" href="javascript:;"><?php echo $xml->Ajouter_au_panier ; ?></a>
                                </div>
                                    ...
                                    jQuery(document).ready(function(){
                                        $('.btn').click(function() {
                                            ...
                                            $.ajax({
                                                    ...
                                                    cache: false,
                                                    success: function(datas){
														window.location="detail_produit.php?region=<?php echo $default_region;?>&nom_region=<?php echo $nom_region;?>&mag_id=<?php echo $row_liste_produits['id_magazin'];?>&titre=<?php echo $nom;?>&id=<?php echo $row_liste_produits['id'];?>&titre_pro=<?php echo $nom_pro;?>&cat_id=<?php echo $row_liste_produits['categorie'];?>&s";
                                                    }
                                                });	
                                            return false;
											}else{
				...
				<div id="tabs-3"  style="position:relative">
                    ...
                    <div>&nbsp;</div>
                    <div id="map"></div>
                    <div style="width:auto; height:360px; position:absolute; top:45px; right:0px;">
