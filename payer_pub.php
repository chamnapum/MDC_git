...
mysql_select_db($database_magazinducoin, $magazinducoin);
$query_Recordset2 = "SELECT pub.titre AS titre_pub, pub_emplacement.prix, pub_emplacement.titre, pub.id 
FROM (pub
...
<br />
          ...
          <form action="payer_pub2.php<?php if(isset($_GET['ap'])) echo "?ap=1"; ?>" method="post">
...
<input name="prix[]" type="hidden" value="<?php echo $row_Recordset2['prix'] ?>" />
<?php } ?>
