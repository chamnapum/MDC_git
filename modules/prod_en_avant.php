...
<?php
    ...
    <div id="slideshow3" style=" width:248px; height:256px; float:left;">
		...
		<div style="width:240px; margin:8px 0px 8px 8px; text-transform:uppercase; height:240px; float:left; background-color:#FFF; <?php if($coupon['photo']){?>  background:url(assets/images/produits/<?php echo $coupon['photo']; ?>) no-repeat; <?php }elseif($coupon['photo1']){?> background:url(assets/images/magasins/<?php echo $coupon['photo1']; ?>) no-repeat; <?php }else{?> background:url(assets/images/def.png) no-repeat; <?php }?> background-size:100% 100%;">
            <a href="md-<?php echo $default_region;?>-<?php echo $nom_region;?>-<?php echo $coupon['id_magazin']; ?>-<?php echo $nom;?>.html#tabs-6">
