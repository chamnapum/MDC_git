...
foreach($map2_result as $cat2){
	...
	if($cat2['parent_id']=='0'){
		...
		echo'<li class="hide1 toutcat" style="background:none; padding:0; margin-top:10px;">'.$listImg.'<a href="javascript:location=\'sub_coupons-'.$nom_region.'-'.$default_region.''.$lien.'\'">' .$cat2['cat_name'].'</a></li>';
	}
	...
	if($cat2['parent_id']==$_GET['categorie']){
		...
		echo'<li class="hide2 niv_1 toutcat" style="background:none; padding:0;">'.$listImg.'<a href="javascript:location=\'sub_sub_coupons-'.$nom_region.'-'.$default_region.''.$lien.'\'">' .$cat2['cat_name'].'</a></li>';
		?>
		<style>
			.hide1{
	...
	if($cat2['parent_id']==$_GET['sous_categorie']){
		...
		echo'<li class="hide3 niv_1 toutcat" style="background:none; padding:0;">'.$listImg.'<a href="javascript:location=\'sub_sub_sub_coupons-'.$nom_region.'-'.$default_region.''.$lien.'\'">' .$cat2['cat_name'].'</a></li>';
		?>
		<style>
            .hide2{
                display:none !important;
...
?>
	...
	<div class="km" style="margin:0px 20px 20px 20px;">
		<div class="ad">
			...
			<img src="timthumb.php?src=assets/images/coupon/<?php echo $row_coupon['photo'] ?>&amp;w=37&amp;h=37&z=1">  
			<?php }?> 
		</div>
		<div class="ad_title">
		...
		<div class="ad_type">
			...
			<a href="pd-<?php echo $default_region;?>-<?php echo $nom_region;?>-<?php echo $row_coupon['id_magazin'];?>-<?php echo $nom;?>-<?php echo $row_coupon['id_coupon'];?>-<?php echo $nom_pro;?>-<?php echo $row_coupon['categories'];?>.html#tabs-5" style="color:#cf8400;">
            	<?php echo count_coupon($row_coupon['id_magazin'],$default_region); ?> Coupon(s) de réduction   
			</a>
			<a href="pd-<?php echo $default_region;?>-<?php echo $nom_region;?>-<?php echo $row_coupon['id_magazin'];?>-<?php echo $nom;?>-<?php echo $row_coupon['id_coupon'];?>-<?php echo $nom_pro;?>-<?php echo $row_coupon['categories'];?>.html#tabs-4" style="color:#9d216e;">
				<?php echo count_event($row_coupon['id_magazin'],$default_region); ?> Événement(s) 
			</a>
			<a href="pd-<?php echo $default_region;?>-<?php echo $nom_region;?>-<?php echo $row_coupon['id_magazin'];?>-<?php echo $nom;?>-<?php echo $row_coupon['id_coupon'];?>-<?php echo $nom_pro;?>-<?php echo $row_coupon['categories'];?>.html#tabs-6" style="color:#b45f93;">
