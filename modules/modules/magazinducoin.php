							...
							?>
                             ...
                             <div style="float:left;padding:12px;">
                      		  <a href="detail_produit.php?id=<?php echo $compte['id_produit'];?>&cat_id=<?php echo $compte['categorie'];?>&mag_id=<?php echo $compte['id_magazin'];?>" class="various3" style="min-height: 282px; height: auto;">
                                  <div class="image"> 
                                    <img src="timthumb.php?src=assets/images/produits/<?php echo $compte['photo1'] ?>&w=118&h=100&z=1">                               </div>
               				 </a>
                       		    <div class="titre">
							<a href="detail_produit.php?id=<?php echo $compte['id_produit'];?>&cat_id=<?php echo $compte['categorie'];?>&mag_id=<?php echo $compte['id_magazin'];?>" class="box prd various3" style="min-height: 282px; height: auto;">
								<?php echo $compte['titre'] ?>
                           	</a>
                       		 </div>
                             </div>
