<div style="float:left; text-align:left;">
	<div class="cart_inner" style="margin:10px !important;">
		...
		if(isset($_SESSION['courses']) or isset($_SESSION['coupons']) or ($_SESSION['event'])){
            ...
            <!--<a href="javascript:;" onclick="window.open ('imprimer.php', 'nom_interne_de_la_fenetre', config='height=700, width=1000, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=no, directories=no, status=no')" class="btnOrange" style="width:125px;"><?php echo $xml->Imprimer_liste; ?></a><br />-->
             ...
             <?php } ?>
			<a href="javascript:;" onClick="ajax('ajax/remiseazero.php','#carts');"  style="width:125px;" class="btnviolet">Remise &agrave; z&eacute;ro</a>
            </div>
            <?php
		} else {
