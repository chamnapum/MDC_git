...
$query_liste_produit = "SELECT magazins.nom_magazin, magazins.logo, magazins.id_magazin, magazins.adresse, magazins.heure_ouverture, magazins.jours_ouverture, magazins.latlan, bons.reduction, bons.id_bon, bons.date_debut, bons.date_fin, bons.titre, bons.min_achat, category.cat_name, maps_ville.nom AS ville, (SELECT COUNT(*)  FROM produits WHERE id_magazin = magazins.id_magazin) AS nb_produits, magazins.photo1
FROM (((bons
LEFT JOIN magazins ON magazins.id_magazin=bons.id_magasin)
LEFT JOIN category ON category.cat_id=bons.categories)
...
$tab = array();
						...
						$tab[] = " bons.date_debut <= '".date('Y-m-d')."'";
						$tab[] = " bons.date_fin >= '".date('Y-m-d')."'";
if($mot_cle)			$tab[] = " bons.titre LIKE '%$mot_cle%' ";
if($magasin)			$tab[] = " magazins.id_magazin = $magasin ";
if($bon) 			$tab[] = " bons.id_bon = ".$bon;
...
<div  class="tri">
	 <div class="tri_inner" >
        ...
        <select name="distance" onchange="ajax(this.value,'#result');">
            ...
            <div class=" counte">
               <?php echo $nbr_total ;?> <?php echo $xml->bon_achat_correspondent_votre_recherche ;?>
            </div>
    	</div>
	</div>
...
?>
 ...
 <?php echo str_replace('-',' '.$xml->A.' ',$liste['heure_ouverture']); ?></div>
                ...
                <div class="box_desc" >
                     ...
                     <span class="magazin"><a href="rechercher.php?adresse=&rayon=999&mot_cle=&categorie=&sous_categorie=&magasin=<?php echo $liste['id_magazin'];  ?>" style="color: #F6AE30;"><?php echo $liste['nb_produits'];?> <?php echo $xml->produits_disponibles_dans_ce_magasin ; ?></a></span> 
                      <div class="prix_inner">
                              <div class="box_prix">
                              	<span class="prix">
								<?php echo $liste['reduction']." &euro;"; ?>
                                </span><br />
                             	 <?php echo $xml->Pour ."  " .$liste['min_achat']." &euro;  ".$xml->achat; ?>
                             </div>
        ...
        <div class="box_event"> 
            <div class="box_evnt" style="width:176px; margin-right:0"><p><a href="javascript:;" onClick="ajax('ajax/addtocartbon.php?id_bon=<?php echo $liste['id_bon']; ?>','#cart');"><?php echo $xml->Ajouter_au_panier ;?></a> </p></div><br />
            ...
            <div class="box_evnt" style="margin-top:0; width:176px; margin-right:0"><p><a href="rechercher_bons.php?adresse=&rayon=999&mot_cle=&categorie=&sous_categorie=&magasin=<?php echo $liste['id_magazin'];?>">
            <?php echo $xml->Tous_les_bons_du_magasin ?></a> </p>
            </div>
         </div>
	</div>
...
<?php }
	...
	foreach($liste_produits_trie as $l) { ?>
        ...
        <div class="box_inner">
            	<div class="boxtitre">
                        <div class="cpn1_titre"><?php echo $xml->Valide_du ?> <?php echo dbtodate($l[1]['date_debut']); ?> <?php echo $xml->au ?> <?php echo dbtodate($l[1]['date_fin']); ?></div>
                ...
                <div class="box_desc" >
                     ...
                     <span class="magazin"><?php echo $l[1]['nb_produits'];?> <?php echo $xml->produits_disponibles_dans_ce_magasin ; ?>:</span> 
                      <div class="prix_inner">
                              <div class="box_prix">
                              	<span class="prix">
                             ...
                             <div class="box_position">
                             	...
                             	<?php if(isset($distance)) { ?>
                                    <div class="distance">
                                     <?php echo $l[1]['ville'];?>  -  <?php echo $xml->Distance; ?>: <?php echo number_format($distance,2,',',' '); ?> KM
                                     </div>
       			 				<?php } ?>
                             </div>
                    </div> 
        ...
        <div class="box_event"> 
            <div class="box_evnt"><p><a href="javascript:;" onClick="ajax('ajax/addtocart.php?id_bon=<?php echo $l[1]['id_bon']; ?>','#cart');"><?php echo $xml->Ajouter_au_panier ;?></a> </p>
            <p><a class="various3" href="itener-mag.php?id_mag=<?php echo $liste['id_magazin'];?>"><?php echo $xml->Itineraire ?></a> </p></div>
         </div>
	</div>
