            ...
            <div class="connection">
            	<ul>
                	<?php if( isset($_SESSION['kt_login_id'])) { ?>
                        <li class="button"><a href="../membre.html">Espace membre</a></li>
                        <li class="button"><a href="../logout.php?logout">Déconnexion</a></li>
                     <?php } else { ?> 
                        <li>
                    	<span id="inscrire"></span><a href="../inscription.html"> S'inscrire</a>
                        </li>
                        <li>
                            <span id="seconnecter"></span><a href="../authetification.html"> Se connecter</a> 
                        </li>
                     <?php } ?>
                     	<li>
										...
										FROM
											...
											INNER JOIN evenements 
												ON (magazins.id_magazin = evenements.id_magazin)
												 where banner='1' and banner_type='1' and banner_start > CURDATE() ORDER BY RAND() LIMIT 0,10";
					...
					<?php if(strpos($_SERVER['PHP_SELF'],'index.php') == FALSE)
                     {
						  ...
						  //echo $default_region;
						  $reg = '<a href="../'.$default_region.'-'.$namede.'.html" style="font-weight:bold; color:#F6AE30;">'.(getRegionById($default_region)).'</a>';
					 } ?> 
