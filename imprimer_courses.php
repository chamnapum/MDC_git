...
<body>
<h1 style="margin:10px auto; width:715px">www.magasinducoin.com - Liste du <?php echo date('d/m/Y'); ?><a class="imp" style="float:right" href="javascript:print();">Imprimer</a></h1>
<div class="lister">
