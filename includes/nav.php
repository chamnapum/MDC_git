...
<?php echo $lang["for_date"]; ?>: <input type="text" name="godate" id="godate" value="<?php echo $m."/".$a."/".$y; ?>" size="10"> <a href="Javascript://" onclick="topcal.select(document.top_form.godate,this.name,'MM/dd/yyyy'); return false;" NAME="anchor_godate" ID="anchor_godate"><img src="assets/images/calendar.png" border="0" /></a>
