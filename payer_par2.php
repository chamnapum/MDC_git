...
if($_POST['paiement'] == 'paypal'){
	...
	"return" => SECUREURL ."payer_par2.php?type=pay&id_coupons=".$_REQUEST['id'],

	"notify_url" => SECUREURL ."notify.php",

	"cancel_return" => SECUREURL ."payer_par2.php?ids=".$_REQUEST['id']."&type=id_coupon",
...
<?php //include("modules/membre_menu.php"); ?>
    ...
    <div style="width:100%;">
        ...
        <?php if(in_array('public',$_SESSION['options'])) { ?> 
        	...
        	<li><?php echo $pub12['titre'];?> <?php echo $pub13['prix'];?> €.</li>
