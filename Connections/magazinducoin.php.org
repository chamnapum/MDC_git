<?php //$url='http://localhost:90/Magasinducoin.v9/';?>
<?php
...
# Type="MYSQL"
# HTTP="true"
/*$hostname_magazinducoin = "bikaycom.fatcowmysql.com";
...
function SendMail_User($email,$id,$nom,$prenom){
	...
	// More headers
	$headers2 .= 'From: <noreply@magasinducoin.com>' . "\r\n";
...
function SendMail_Shopper_Webmaster($email,$nom,$prenom,$nom_magazin,$adresse,$siren,$telephone){
	...
	$to2 = 'validation@magasinducoin.com';//
	...
	// More headers
	$headers2 .= 'From: <validation@magasinducoin.com>' . "\r\n";
	//$headers .= 'Cc: myboss@example.com' . "\r\n";
