...
$query = mysql_query("select distinct(ville_lower), code_postal from magazins_r where id_ville = 0 order by rand()");
$count = 0;
echo 'start';
while($row = mysql_fetch_array($query)){
	...
	$sql = "UPDATE magazins_r SET id_ville=(select v.id_ville from maps_ville2 v where nom_lower = '$ville_lower' and cp = '$code_postal' limit 1) where ville_lower = '$ville_lower' and code_postal = '$code_postal'";
