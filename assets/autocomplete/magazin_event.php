...
FROM
    ...
    INNER JOIN evenements 
        ON (magazins.id_magazin = evenements.id_magazin) WHERE magazins.nom_magazin LIKE '%".($q)."%' AND magazins.approuve='1' AND magazins.activate='1' AND magazins.payer='1' GROUP BY magazins.id_magazin ORDER BY magazins.nom_magazin ASC";
